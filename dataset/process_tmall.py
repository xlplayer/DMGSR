...
# Tmall's raw data is download from  https://www.dropbox.com/sh/dbzmtq4zhzbj5o9/AACldzQWbw-igKjcPTBI6ZPAa?dl=0

parser = argparse.ArgumentParser()
parser.add_argument('--dataset', default='Tmall', help='dataset name: sample')
